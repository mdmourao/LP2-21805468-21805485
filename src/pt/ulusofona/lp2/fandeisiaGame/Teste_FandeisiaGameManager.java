...
public class Teste_FandeisiaGameManager {
    ...
    public void test_turnOeste(){
        ...
        assertEquals("2 | Circulo | 0 | 0 @ (1, 4) Sul",test1.creatures.get(1).toString());
        test1.processTurn();
        assertEquals("1 | Circulo | 0 | 0 @ (1, 2) Oeste",test1.creatures.get(0).toString());
        assertEquals("2 | Circulo | 0 | 0 @ (1, 6) Sul",test1.creatures.get(1).toString());
    }
